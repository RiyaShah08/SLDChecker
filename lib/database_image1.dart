...
import 'package:sldchecker/screening1.dart';

class data_image1 extends StatelessWidget {
  const data_image1({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                        children: [
                          Expanded(
                            child: Image.asset('asset/b.png', height: 400, width: 400),
                          ),
                        ]),),
                  ...
                  Padding(
                      ...
                      child: IconButton(icon: Icon(Icons.next_plan_rounded, size: 40), onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Screentest1(), ), );
