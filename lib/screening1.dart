...
import 'package:sldchecker/screenwork.dart';

class Screentest1 extends StatefulWidget {
  const Screentest1({Key? key}) : super(key: key);

  @override
  State<Screentest1> createState() => _Screentest1State();
}

class _Screentest1State extends State<Screentest1> {
            ...
            children: [
              ...
              Padding(
                  ...
                  child: IconButton(icon: Icon(Icons.next_plan_rounded, size: 40), onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Screen_work(), ), );
